...
def get_tokenizer_from_vocab_merges_path(
    ...
    with open(vocab_path, 'r', encoding='utf-8', errors='replace') as vocab_f:
        gpt2_vocab = json.load(vocab_f)
    gpt2_bpe_merges = []
    with open(merges_path, 'r', encoding='utf-8', errors='replace') as f:
        for line in f:
...
def test_address_roundtrip():
    ...
    # 改成这个就能过测试
    with open(FIXTURES_PATH / "address.txt", 'r', encoding='utf-8', errors='replace') as f:
        corpus_contents = f.read()
...
def test_german_roundtrip():
    ...
    with open(FIXTURES_PATH / "german.txt", 'r', encoding='utf-8', errors='replace') as f:
        corpus_contents = f.read()
...
def test_tinystories_sample_roundtrip():
    ...
    with open(FIXTURES_PATH / "tinystories_sample.txt", 'r', encoding='utf-8', errors='replace') as f:
        corpus_contents = f.read()
...
def test_encode_iterable_memory_usage():
    ...
    with open(FIXTURES_PATH / "tinystories_sample_5M.txt", 'r', encoding='utf-8', errors='replace') as f:
        ids = []
